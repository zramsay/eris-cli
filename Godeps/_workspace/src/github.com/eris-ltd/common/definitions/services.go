...
type Service struct {
	...
	CPUShares   int64             `json:"cpu_shares,omitempty,omitzero" yaml:"cpu_shares,omitempty,omitzero" toml:"cpu_shares,omitempty,omitzero"`
	...
	MemLimit    int64             `json:"memory,omitempty,omitzero" yaml:"memory,omitempty,omitzero" toml:"memory,omitempty,omitzero"`
}
