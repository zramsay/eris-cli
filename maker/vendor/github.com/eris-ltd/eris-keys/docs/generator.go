...
var Description = "Development Signing Daemon Tooling"                        // should match the docs site name
var RenderDir = fmt.Sprintf("./docs/documentation/keys/%s/", version.VERSION) // should be the "shortversion..."
...
func main() {
	...
	if err = RenderFiles(keys, tmpl); err != nil {
		panic(err)
	}
}
