...
and files in the ` + util.Tilde(ChainsPath) + ` directory. Addtional flags can be used to remove 
...
func addCleanFlags() {
	...
	Clean.Flags().BoolVarP(&do.ChnDirs, "chains", "x", false, "remove latent chain data in "+util.Tilde(ChainsPath))
