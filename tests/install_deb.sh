...
apt_source_path="/etc/apt/sources.list.d/eris_eris.list"
apt_config_url="https://packagecloud.io/install/repositories/eris/eris/config_file.list?os=${os}&dist=${dist}&name=${host}&source=script"
