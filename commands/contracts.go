...
func addContractsFlags() {
	...
	contractsTest.Flags().BoolVarP(&do.Running, "summary", "u", true, "output a table summarizing epm jobs (EPM only)")
	...
	contractsTest.Flags().StringVarP(&do.Compiler, "compiler", "l", "compilers.eris.industries:8091", "<ip:port> of compiler which EPM should use (EPM only)")
	...
	contractsDeploy.Flags().BoolVarP(&do.Running, "summary", "u", true, "output a table summarizing epm jobs (EPM only)")
	...
	contractsDeploy.Flags().StringVarP(&do.Compiler, "compiler", "l", "compilers.eris.industries:8091", "<ip:port> of compiler which EPM should use (EPM only)")
