...
* For details on permissioning, secure natives, and the eris-db API, see the [eris-db repository](https://github.com/monax/burrow)
* For information about the javascript libraries, see the [eris-contracts.js](https://github.com/monax/eris-contracts.js), [eris-db.js](https://github.com/monax/burrow.js), and [eris-keys.js](https://github.com/monax/eris-keys.js) repositories.
