...
var RENDER_DIR = fmt.Sprintf("./docs/eris-cli/%s/", strings.Split(version.VERSION, "-")[0])

var SPECS_DIR = "./docs/"

var BASE_URL = fmt.Sprintf("https://docs.erisindustries.com/documentation/eris-cli/%s/", strings.Split(version.VERSION, "-")[0])
